...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="table">
        <tr>
            ...
            <td><a href="Reservas.aspx?idCabaña=<%=item.Id.ToString()%>&idUsuario=<%=((Dominio.Usuario)Session[Session.SessionID+"userSession"]).Id.ToString()%>" class="btn btn-success mr-auto ml-auto">Reservar</a> </td>
